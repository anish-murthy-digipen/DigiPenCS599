...
void VkApp::createRenderTarget()
{
    ...
    // @@ Destroy with m_renderTarget.destroy(m_device);
}
...
void VkApp::createScRenderPass()
{
    ...
    // @@ Verify success of vkCreateRenderPass and vkCreateFramebuffer
    // @@ Destroy with vkDestroyRenderPass(m_device, m_scRenderPass, nullptr);
    // @@ Destroy with vkDestroyFramebuffer(m_device, m_scFramebuffer, nullptr);
}
...
void VkApp::createScPipeline()
{
    ...
    // @@ Verify success of vkCreatePipelineLayout (found about 120 lines upward).
    // @@ To destroy:  vkDestroyPipelineLayout(m_device, m_scPipelineLayout, nullptr);
    // @@  and:        vkDestroyPipeline(m_device, m_scPipeline, nullptr);
}
